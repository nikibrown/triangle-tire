...
$qstring = ( $type !== false ) ? $qo->query_var . '/'. $qo->rewrite['slug'] : null;
    ...
    <div class="interiorbanner expanded row">
        <div class="large-12">
        		<?php
					...
					} elseif ( get_post_type() == 'trailer_tires' ) {
						echo '<img src=" https://triangletireus.com/wp-content/themes/triangle-new/images/passenger-tire-header.jpg">';
        			}
        		?>
        </div>
	...
	<div class="tirelist row">
		...
		if( !$searching )
		{
			...
			if ( have_posts() ) :
				while ( have_posts() ) :
					...
					<div class="medium-6 large-6 small-12 columns">
						...
						<div class="printemailspecs text-center">
							...
							<a href="<?php bloginfo( 'url' ); ?>/warranties">
				...
				//no posts found ?>
				<h2>Sorry, no results found for your search. Try <a href="#" class="js-nav-search--trigger">searching again</a> or visiting our <a href="#">FAQ page</a> for answers.</h2>
				<?php
			endif;
		}
		else
